  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8">
      ...
      <div className="flex flex-col gap-3 md:gap-4">
        <p className="font-bold uppercase tracking-[0.08em] text-[13px] md:text-[14px]" style={{ color: PURPLE }}>
          UXHICon &bull; Saturday, October 17, 2026
        </p>
        <SectionHeading>Share, Learn, &amp; Connect</SectionHeading>
        <p className="font-normal leading-[1.4] tracking-[-0.02em] text-[16px] sm:text-[17px] md:text-[19px] lg:text-[22px] xl:text-[28px]" style={{ color: GRAY }}>
      ...
      <div className="flex flex-col gap-3 md:gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="inline-flex w-fit items-center gap-2 h-[44px] px-5 rounded-full text-[15px] font-normal text-white no-underline hover:opacity-80 transition-opacity whitespace-nowrap mt-1"
