...
const siteSettings = {
  ...
  mainNavigation: [
    ...
    { _key: "2", label: "Find Experts", linkType: "internal", internalLink: "/find-experts" },
    ...
    { _key: "6", label: "Shop", linkType: "internal", internalLink: "/shop" },
  ],
  ...
  footerNavigation: [
    ...
    { _key: "3", label: "Find Experts", linkType: "internal", internalLink: "/find-experts" },
    ...
    { _key: "7", label: "Shop", linkType: "internal", internalLink: "/shop" },
  ],
