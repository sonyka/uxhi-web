      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="text-sm text-gray-110 space-y-1">
            ...
            <p><span className="font-mono text-xs bg-gray-20 px-1 rounded">iconNudge</span> and <span className="font-mono text-xs bg-gray-20 px-1 rounded">iconGap</span>: optical trims in px, for placements the shared offset does not quite suit — the mission statement lifts 2px, the /join trigger opens its gap 2px. Reach for these last; a placement needing more than a trim usually wants a size</p>
