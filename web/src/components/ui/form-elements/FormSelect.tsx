    ...
    <div ref={dropdownRef} className={cn("relative", className)}>
      ...
      <button
        ...
        className={cn(
          ...
          selectedValue ? "text-white" : "text-purple-30",
        )}
      >
        ...
        <svg
          className={cn("w-4 h-4 text-purple-30 transition-transform flex-shrink-0 ml-2", isOpen && "rotate-180")}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : "text-purple-30 hover:bg-white/10",
                  )}
                >
