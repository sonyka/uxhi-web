    ...
    function addPopoverStyles() {
        ...
        styles.textContent = `
            ...
            a[href*="htdc.org"].framer-b0f68b {
                background-image: url('/conferences/2024/assets/images/htdc-logo.svg') !important;
                background-size: contain !important;
                background-repeat: no-repeat !important;
                background-position: center !important;
            }
            ...
            a[href*="shakaguide.com"].framer-k8lxjp {
                background-image: url('/conferences/2024/assets/images/shaka-guide-logo.png') !important;
                background-size: contain !important;
                background-repeat: no-repeat !important;
                background-position: center !important;
            }
